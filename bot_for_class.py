...
class Group9(BaseBot):
    def _roll_bank_or_quit(self):
        """your logic here"""
        if self.unbanked_points >= 1800 and self.dice_remaining == 5:
            return "b"
        if self.unbanked_points >= 900 and self.dice_remaining == 4:
            return "b"
        if self.unbanked_points >= 400 and self.dice_remaining == 3:
            return "b"
        if self.unbanked_points >= 300 and self.dice_remaining == 2:
            return "b"
        if self.unbanked_points >= 200 and self.dice_remaining == 1:
            return "b"
